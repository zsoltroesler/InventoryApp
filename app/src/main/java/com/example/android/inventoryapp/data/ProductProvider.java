...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // MULTIPLE rows of the product table.
    ...
    /**
     * Read data from products table either the whole table or a specific row
     */
    @Override
    ...
    /**
     * Supporting method to insert a product into the database with the given content values.
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // Check that the supplier e-mail address is not null
    ...
    /**
     * Update the whole table or a single row
     */
    @Override
    ...
    /**
     * Supporting method to update a product into the database with the given content values.
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // check that the image URI is valid.
        ...
        // check that the supplier e-mail value is valid.
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_SUPPLIER_EMAIL)) {
            String email = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER_EMAIL);
            if (email == null) {
                throw new IllegalArgumentException("Product requires supplier email");
    ...
    /**
     * Delete the whole table or a single row
     */
    @Override
    ...
    /**
     * Get which type of URI used to query the products table
     */
    @Override
